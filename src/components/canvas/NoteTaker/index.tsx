      ...
      >
        <CanvasForNotes>
          {notesAtPointInTime.map((timenote) => {
            return timenote.notes.map((note, i) => {
              return (
                <div>
                  {note.id === 1 ? <div></div> : ""}
                  ...
                  <textarea id={`${note.id.toString()} ${timenote.id.toString()}`} onChange={editNote} value={note.content} name="" cols={60} rows={10}></textarea>
                </div>
              )
            })
          })}
      ...
      {id !== 0 ? (
        <>
          <div style={{ width: "500px", margin: "auto" }}>
            ...
            <Slider defaultValue={minMaxValue?.timeIn} onChange={setTimeIn} valueLabelDisplay="auto" aria-labelledby="continuous-slider" min={0} max={0.999999} step={0.000001} />
            ...
            <Slider defaultValue={minMaxValue?.timeOut} onChange={setTimeOut} valueLabelDisplay="auto" aria-labelledby="continuous-slider" min={0} max={0.999999} step={0.000001} />
            <small>
